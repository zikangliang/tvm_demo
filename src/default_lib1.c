...
// 初始化算子条目
// ============================================================
static int init_op_execs(float *input, float *output, uint8_t *workspace,
...
extern "C"
#endif
    int32_t
    tvmgen_default___tvm_main__(float *input_buffer_var,
  ...
  // 初始化算子条目
  init_op_execs(input_buffer_var, output_buffer_var, global_workspace_1_var,
